...
public class MyProgressBar extends JFrame {
	...
	public MyProgressBar(FindTable mf, String keyvalue) {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				MyProgressBar.this.mf.doStringBuild(rowData);
				dispose();
			}
	...
	private class Progress extends Thread {
		...
		public void run() {
			...
			try{
			rowData = FindService.getStudentInfo(str[0], str[1]);
			}catch(Exception e){
				MyProgressBar.this.mf.showDialog();
			}
