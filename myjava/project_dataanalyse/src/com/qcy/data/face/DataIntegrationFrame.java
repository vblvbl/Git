...
public class DataIntegrationFrame extends JFrame {

	JLabel blnew = new JLabel("新表名：");
	private final JTextField newTableNameText = new JTextField(20);
	...
	public DataIntegrationFrame() throws Exception {
